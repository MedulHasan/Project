window.onload = function () {
    tinymce.init({
        selector: 'textarea',
        height: 300,
        plugins: 'a11ychecker advcode advlist casechange formatpainter linkchecker autolink lists link checklist media mediaembed pageembed permanentpen powerpaste table advtable tinycomments tinymcespellchecker image imagetools emoticons preview',
